...
static void	ft_cost_first_half(t_var *v, int steps_a, int steps_brut,
		t_lst *curr_a)
{
	if (steps_a <= v->size_a / 2)
	{
...
static void	ft_cost_second_half(t_var *v, int steps_a, int steps_brut,
		t_lst *curr_a)
{
...
void	ft_cost(t_var *v)
{
	...
	while (curr_a)
	{
		...
		if (steps_brut <= v->size_b / 2)
			ft_cost_first_half(v, steps_a, steps_brut, curr_a);
		else if (steps_brut > v->size_b / 2)
			ft_cost_second_half(v, steps_a, steps_brut, curr_a);
		steps_a++;
		curr_a = curr_a->next;
	}
}
